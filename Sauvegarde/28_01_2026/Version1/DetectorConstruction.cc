...
void DetectorConstruction::ConstructGDML()
{
        ...
        // ==========================================================================
        // Géométrie :
        // - 4 couronnes d'eau concentriques, épaisseur radiale 5 mm chacune
        // - Couronne 0 (disque central) : r = 0-5 mm
        // - Couronne 1 : r = 5-10 mm, Couronne 2 : r = 10-15 mm, Couronne 3 : r = 15-20 mm
        ...
        const G4double ringRadialThick = 5.0*mm;      // épaisseur radiale des couronnes
        const G4double waterRadius = 20.0*mm;         // rayon total = 4 × 5 mm
        const G4double pvcThickness = 1.0*mm;         // épaisseur parois PVC
        const G4double containerHeight = 5.0*mm;      // hauteur totale conteneur
        ...
        solidPVCBottom = new G4Tubs("solidPVCBottom",
                                     ...
                                     waterRadius + pvcThickness,      // rayon externe = 21 mm
        ...
        solidPVCWall = new G4Tubs("solidPVCWall",
                                   waterRadius,                       // rayon interne = 20 mm
                                   waterRadius + pvcThickness,        // rayon externe = 21 mm
        ...
        const G4double blueShades[kNbWaterRings] = {0.5, 0.67, 0.83, 1.0};
