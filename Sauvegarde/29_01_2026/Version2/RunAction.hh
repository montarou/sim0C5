...
class RunAction : public G4UserRunAction
{
    public:
        ...
        // Pour les histogrammes par 1000 événements
    ...
    private:
        ...
        // Pour les histogrammes par 1000 événements
        G4double fEdepRing1000[kNbWaterRings] = {0., 0., 0., 0., 0.};
        G4double fEdepWater1000 = 0.;
        G4int fLastHistoFillEvent = -1000;  // pour suivre quand on a rempli les histos
