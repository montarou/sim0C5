...
void SetupAnalysis()
{
    ...
    // ============================================================================
    // NTUPLE plane_passages (ScorePlane à z = 18 mm)
    // ============================================================================
    // [FIX] Structure HARMONISÉE avec les autres ntuples (ScorePlane2, WaterRings, etc.)
    // Colonnes: pdg, name, is_secondary, x_mm, y_mm, z_mm, ekin_keV, trackID, parentID, creator_process
    // Note: z_mm est gardé pour plane_passages car c'est un plan mince (pas un volume)
    // ============================================================================
